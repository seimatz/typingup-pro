<template>
  ...
  <p>Typing-up.pro is the web app for practicing touch typing in various languages.</p>
  <p>The app is made with Vue.js. You can see code at <a href="https://github.com/seimatz/typingup-pro">github repository</a>.</p>
  <h2 class="title is-size-4 mt-5">1. Select language or upload your own texts.</h2>
